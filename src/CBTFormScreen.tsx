...
import { CBT_LIST_SCREEN, EXPLANATION_SCREEN, LOCATION1_SCREEN } from "./screens";
          ...
          <Container>
            <Row>
              <IconButton
                ...
                onPress={() => {
                  flagstore.setFalse("start-help-badge").then(() => {
                    ...
                    this.props.navigation.push(LOCATION1_SCREEN);
                  });
                }}
              ...
              <IconButton
                ...
                onPress={() => this.props.navigation.push(LOCATION1_SCREEN)}
              />
            </Row>
